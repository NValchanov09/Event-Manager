...
namespace EventManagerBackend.Migrations
{
    ...
    [Migration("20250717154942_Initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EventManagerBackend.Models.Event", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("EventManagerBackend.Models.Submission", b =>
                {
                    ...
                    b.HasOne("EventManagerBackend.Models.User", "User")
                        .WithMany("Submissions")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("EventManagerBackend.Models.User", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
